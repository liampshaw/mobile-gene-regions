...
# plot linear blocks
python ../../scripts/plot_linear_blocks_altair.py --block_csv ../output/CTX-M-65/pangraph/CTX-M-65_pangraph.json.blocks.csv --output CTX-M-65-figure-v2/plot_ctxm65_0diff_subset.html --strain_list tmp_ctxm65_0diff.txt
python ../../scripts/plot_linear_blocks_altair.py --block_csv ../output/CTX-M-65/pangraph/CTX-M-65_pangraph.json.blocks.csv --output CTX-M-65-figure-v2/plot_ctxm65_1diff_ctxm24_subset.html --strain_list tmp_ctxm65_1diff_ctxm24.txt
python ../../scripts/plot_linear_blocks_altair.py --block_csv ../output/CTX-M-65/pangraph/CTX-M-65_pangraph.json.blocks.csv --output CTX-M-65-figure-v2/plot_ctxm65_2diff_ctxm14_subset.html --strain_list tmp_ctxm65_2diff_ctxm14.txt
