...
def get_options():
    ...
    parser.add_argument('--snv_threshold', help='maximum number of allowed differences in central gene', required=False, default=25)
...
def main():
    ...
    if results is None:
        ...
        extractions = extract_regions(input_sequences, results,
                                    ...
                                    length_threshold=float(args.gene_length_threshold))
        N_seqs_written = 0
        seqs_written = []
